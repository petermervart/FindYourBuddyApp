...
import kotlinx.android.synthetic.main.activitywebrtc_main.*
...
//            signallingClient.send(p0)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activitywebrtc_main)
        ...
        end_call_button.setOnClickListener {
            ...
            finish()
            startActivity(Intent(this@RTCActivity, MainActivityWebRTC::class.java))
        }
    }
