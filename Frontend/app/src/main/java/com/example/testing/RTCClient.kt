                ...
                .get().addOnSuccessListener {
                    ...
                    for ( dataSnapshot in it) {
                        if (dataSnapshot.contains("type") && dataSnapshot["type"]=="offerCandidate") {
                            ...
                            db.collection("calls").document(meetingID).collection("candidates").document("offerCandidate").delete()
                            ...
                            db.collection("calls").document(meetingID).collection("candidates").document("answerCandidate").delete()
                        }
                    }
